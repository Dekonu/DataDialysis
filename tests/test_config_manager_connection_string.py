    ...
    def test_environment_individual_fields_construct_connection_string(self):
        ...
        try:
            ...
            try:
                ...
                # If dotenv is not installed, patch at the config_manager level instead
                dotenv_patch = patch('src.infrastructure.config_manager.load_dotenv', side_effect=lambda *args, **kwargs: None)
